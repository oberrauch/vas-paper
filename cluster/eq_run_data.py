...
def get_eq_volume(out_path=None, vas=True):
    ...
    # store to file
    if not out_path:
        out_path = os.path.join(dir_path, f"{'vas' if vas else 'fl'}_volume_rgi_region.nc")
...
if __name__ == '__main__':
    # handle scaling model output
    # get_eq_volume(vas=True)
    # handle OGGM flowline model output
    get_eq_volume(out_path='/home/users/moberrauch/run_output/eq_runs/fl_volume_rgi_region.nc', vas=False)
