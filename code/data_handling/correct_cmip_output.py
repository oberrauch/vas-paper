...
def correct_eq_volume(rgi_reg, vas=True, log_file_path='logfile.txt'):
    ...
    if vas:
        ...
        dir_path = '/home/www/https://cluster.klima.uni-bremen.de/~oggm/' \
                   'gdirs/oggm_v1.4/L3-L5_files/CRU/elev_bands/qc3/pcp2.5/' \
                   'match_geod/RGI62/b_080/L3/summary/'
    ...
    for gcm in gcms:
        # load entire dataset
        sub_dir = f'RGI{rgi_reg:02d}/'
        f_name = f'bias{temp_bias:+.1f}.nc'
        f_path = os.path.join(dir_path, sub_dir, f_name)
